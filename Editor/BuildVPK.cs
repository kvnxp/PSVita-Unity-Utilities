...
namespace PSVitaUtilities.Building
{
    public class BuildVPK : EditorWindow
    {
        ...
        [MenuItem("PSVita/🔼Upload file (VPK)")]
        public static void Upload()
        {
            PSVitaUtilitiesSettings.LoadSettings();
            var filePath = EditorUtility.OpenFilePanel("Open File VPK", "", "vpk");
            String filename = Path.GetFileName(filePath);
            string ip = PSVitaUtilitiesSettings.PSVitaIP;
            Debug.Log("nose");
            TransferFTPVPK(filePath);
        }
        ...
        public static void TransferFTPVPK(string _filePath)
        {
            ...
            string _ip = "ftp://" + PSVitaUtilitiesSettings.PSVitaIP + ":1337/" + "ux0:" + "/downloads" + "/" + System.IO.Path.GetFileName(_filePath);
            Uri uri = new Uri(_ip);
            ...
            Thread a = new Thread(() =>
            {
                ...
                {
                    Debug.Log("Uploading ...");
                    client.UploadFile(uri, _filePath);
                    Debug.Log("the file are uploaded to ux0:/downloads folder");
                }
